#!/usr/bin/python3
"""
This File defines the BaseModel model that will
serve as the base model for all our models."""
...
class BaseModel:
    ...
    @classmethod
    def all(cls):
        """Retrieve all current object of cls"""
        return models.storage.find_all(cls.__name__)

    @classmethod
    def count(cls):
        """Get the number of all current object of cls"""
